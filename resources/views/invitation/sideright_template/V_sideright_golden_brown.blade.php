@extends('invitation.sideright_template.V_sideright_layout')
...
@section('content')
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <!-- audio button -->
        <button id="toggle-audio" class="mt-4 hidden rounded-full bg-primary-golden-brown-500 px-4 py-2 text-sm text-white hover:bg-primary-golden-brown-600">
            <i class="fas fa-pause"></i>
        </button>
        <audio id="background-audio" loop="">
            @if ($invitation->audio)
                <source src="{{ url('/invitations/sideright_template/play_audio/' . $invitation->audio->audio_file) }}" type="audio/mpeg">
        ...
        <div id="content" class="ml-auto h-screen w-full overflow-y-hidden sm:w-1/2 lg:w-1/3">
            ...
            <section class="relative h-screen w-full">
                <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/main-image.jpg" class="absolute h-full w-full object-cover" alt="Background Image" />
                ...
                <div class="relative z-10 flex h-full flex-col items-center justify-center text-center text-primary-golden-brown-400">
                    ...
                    <div data-aos="fade-up">
                        <button id="open-invitation" class="mx-auto mt-6 rounded-full bg-primary-golden-brown-500 px-4 py-2 text-base text-white hover:bg-primary-golden-brown-600">
                ...
                <section id="secondary-section" class="relative h-screen w-full">
                    <div class="relative h-full w-full overflow-hidden">
                        <div class="relative z-20 flex h-full items-center px-4 pb-20 text-right">
                            <div class="text-base text-primary-golden-brown-400" data-aos="fade-left" style="z-index: 20">
            ...
            @if ($invitation->wedding_couple)
                <section class="relative h-full w-full bg-white">
                    <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/flower-1.png" class="absolute top-0 z-10 w-full object-cover" />

                    <div class="relative px-4 py-44 text-center text-primary-golden-brown-400 overflow-hidden">
                        <div data-aos="fade-down">
                        ...
                        <div data-aos="fade-right">
                            <img src="{{ Storage::url($invitation->wedding_couple->bride_photo) }}" class="mx-auto h-[400px] w-2/3 rounded-b-[30%] rounded-t-[30%] border-4 border-primary-golden-brown-400 object-cover" />
                        ...
                        <div data-aos="fade-left">
                            ...
                            <img src="{{ Storage::url($invitation->wedding_couple->groom_photo) }}" class="mx-auto h-[400px] w-2/3 rounded-b-[30%] rounded-t-[30%] border-4 border-primary-golden-brown-400 object-cover" />
                    ...
                    <div class="relative">
                        <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/flower-4.png" class="absolute bottom-0 z-10 w-full object-cover" />
                    </div>
                </section>
            @endif
            ...
            @if ($invitation->event)
                <section class="relative h-full w-full bg-gradient-to-l from-black to-gray-800">
                    <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/flower-2.png" class="absolute w-full object-cover" />
                    <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/layer-1a.png" class="relative z-10 w-full object-cover px-2 pt-2" />

                    <div class="relative z-10 text-primary-golden-brown-400 overflow-hidden">
                        <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/layer-1b.png" class="absolute h-full w-full px-2" />

                        <div class="relative z-20 px-8 text-center text-primary-golden-brown-400">
                            @if (!empty(trim($invitation->event->event_date_1)))
                                <div data-aos="fade-right">
                                    ...
                                    <a href="{{ $invitation->event->map_url_1 }}" target="_blank">
                                        <button class="mx-auto mt-1 rounded-full bg-primary-golden-brown-500 px-4 py-2 text-sm text-white hover:bg-primary-golden-brown-600">
                    ...
                    <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/layer-1c.png" class="relative z-10 w-full object-cover px-2 pb-2" />
                    <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/flower-3.png" class="absolute bottom-0 w-full object-cover" />
                </section>
            @endif
                ...
                <section class="relative h-full w-full bg-gradient-to-l from-black to-gray-800">
                    <div class="px-4 py-8">
                        <div data-aos="flip-left">
                            <p class="mb-4 text-center font-sacramento text-4xl font-semibold text-primary-golden-brown-400">
                                Galeri
                            </p>
                        </div>
                    ...
                    <div data-aos="flip-left">
                        <div class="px-4 py-8">
                            <div class="flex justify-center">
                                <iframe class="rounded-lg" width="560" height="315" src="https://www.youtube.com/embed/{{ $invitation->streaming->youtube_url_id }}" title="YouTube video player" frameborder="0"
                    ...
                    <div class="px-4 py-8">
                        ...
                        @foreach ($invitation->love_stories as $index => $item)
                            <div class="{{ $loop->last ? '' : 'mb-4' }}" data-aos="zoom-in">
                                <div class="mx-auto max-w-4xl rounded-3xl border-2 border-primary-golden-brown-400 bg-white p-4 shadow-lg">
            ...
            @if (!$invitation->gifts->isEmpty())
                <section class="relative h-full w-full bg-gradient-to-l from-black to-gray-800">
                    <div class="px-4 py-8">
                        ...
                        <div data-aos="flip-right">
                            <div class="mx-auto max-w-4xl rounded-3xl border-2 border-primary-golden-brown-400 bg-white p-6 shadow-lg">
                                <p class="text-justify text-base text-gray-500">
                                    Bagi yang ingin memberikan tanda kasih, dapat mengirimkan melalui fitur di bawah ini:
                                </p>

                                <button id="open-modal" class="mt-4 w-full rounded-full bg-primary-golden-brown-500 p-3 text-base text-white hover:bg-primary-golden-brown-600">
                        ...
                        <div class="max-h-[70vh] overflow-y-auto px-4 pb-8 pt-4">
                            ...
                            @foreach ($bankAccounts as $item)
                                <div class="relative mb-4">
                                    <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/card-money.jpg" class="h-40 w-full rounded-3xl border-2 border-primary-golden-brown-400 object-cover" />
                                    <div class="absolute inset-0 flex flex-col items-start justify-center pl-4">
                                        <p class="px-4 py-1 text-2xl font-semibold text-primary-golden-brown-400">{{ $item->account_name }}</p>
                                        <p class="px-4 py-1 text-2xl">
                                            {{ $item->account_number }}
                                            <i id="copy-icon" class="fa-regular fa-copy cursor-pointer hover:text-primary-golden-brown-400" onclick="copyToClipboard('bg-primary-golden-brown-500', '{{ $item->account_number }}')"></i>
                                        </p>
                            ...
                            @foreach ($other_gifts as $item)
                                <div class="relative mb-4">
                                    <div class="flex rounded-3xl border-2 border-primary-golden-brown-400 p-2">
                                        <div class="flex items-center px-4">
                                            <i class="fas fa-gift text-3xl text-primary-golden-brown-400"></i>
                                        </div>
                                        <div class="flex flex-col justify-center">
                                            ...
                                            <p class="px-1 py-1 text-base">
                                                ...
                                                <i id="copy-icon" class="fa-regular fa-copy cursor-pointer text-2xl hover:text-primary-golden-brown-400"
                                                    onclick="copyToClipboard('bg-primary-golden-brown-500', '{{ $item->recipient_name . ' / ' . $item->recipient_phone_number . ' / ' . $item->recipient_address }}')""></i>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mx-auto max-w-4xl rounded-3xl border-2 border-primary-golden-brown-400 bg-white p-6 shadow-lg">
                            <form id="message-form" onsubmit="sendMessage(event, 'bg-primary-golden-brown-500')">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Masukkan nama Anda" class="w-full rounded-md border border-primary-golden-brown-400 p-3 focus:outline-none focus:ring-2 focus:ring-primary-golden-brown-400" />
                                </div>
                                <div class="mb-4">
                                    <label for="message" class="mb-2 block text-left text-sm font-semibold text-gray-500">Pesan</label>
                                    <textarea name="message" id="message" placeholder="Berikan ucapan serta doa restu Anda" class="w-full rounded-md border border-primary-golden-brown-400 p-3 focus:outline-none focus:ring-2 focus:ring-primary-golden-brown-400" rows="4"></textarea>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4" id="guest_input" style="display: none;">
                                    <label for="guest_totals" class="mb-2 block text-left text-sm font-semibold text-white">Jumlah
                                        Tamu</label>
                                    <input type="number" name="guest_totals" id="guest_totals" placeholder="Masukkan jumlah tamu (orang)" class="w-full rounded-md border border-primary-golden-brown-400 p-3 focus:outline-none focus:ring-2 focus:ring-primary-golden-brown-400" />
                                </div>
                                <button type="submit" class="mt-4 w-full rounded-full bg-primary-golden-brown-500 p-3 text-base text-white hover:bg-primary-golden-brown-600">
            ...
            @if ($invitation->closing)
                <section class="relative h-full w-full bg-gradient-to-l from-black to-gray-800">
                    <div data-aos="fade-up">
                        <div class="px-4 pt-8 text-center text-primary-golden-brown-400">
                    ...
                    <img src="{{ asset('/') }}invitation_templates/jm-sideright/dist/assets/image/golden_brown/flower-5.png" class="absolute bottom-0 z-10 w-full object-cover" />
                </section>
            @endif
                        ...
                        @if (!$contacts->isEmpty())
                            <div class="mb-4 flex space-x-4">
                                @foreach ($contacts as $item)
                                    <a href="{{ $item->url }}" class="hover:text-primary-golden-brown-400" title="{{ $item->platform }}" target="_blank">
