        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Ubah Undangan</div>
                </div>
            </div>
            <div class="section-body">
                ...
                @endif
                <form action="{{ isset($invitation->cover) ? route('invitations.sideright_template.action_cover', $invitation->cover->uuid) : route('invitations.sideright_template.action_cover') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <x-input_file type="text" name="cover_image" label="Gambar Cover" :value="$invitation->cover->cover_image ?? ''" />
                ...
                @endif
                <form action="{{ isset($invitation->wedding_couple) ? route('invitations.sideright_template.action_wedding_couple', $invitation->wedding_couple->uuid) : route('invitations.sideright_template.action_wedding_couple') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    @php
                                        ...
                                        $text_greeting = 'Dengan memohon Wanitat dan Ridho Allah SWT kami bermaksud untuk mengundang Bapak/Ibu/Saudara/i untuk menghadiri acara pernikahan kami:';
                                    @endphp
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <x-input_file type="text" name="bride_photo" label="Foto Mempelai Wanita" :value="$invitation->wedding_couple->bride_photo ?? ''" />
                                        <small class="text-info">Maximal ukuran 5MB.</small>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <x-input_file type="text" name="groom_photo" label="Foto Mempelai Pria" :value="$invitation->wedding_couple->groom_photo ?? ''" />
                                        <small class="text-info">Maximal ukuran 5MB.</small>
                                    </div>
                                    <div class="mb-3">
                ...
                @endif
                <form action="{{ isset($invitation->quote) ? route('invitations.sideright_template.action_quote', $invitation->quote->uuid) : route('invitations.sideright_template.action_quote') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <x-input_file type="text" name="background_image_1" label="Gambar Latar belakang 1" :value="$invitation->quote->background_image_1 ?? ''" />
                                        <small class="text-info">Maximal ukuran 5MB.</small>
                                    </div>
                                    <div class="mb-3">
                                        <x-input_file type="text" name="background_image_2" label="Gambar Latar belakang 2" :value="$invitation->quote->background_image_2 ?? ''" />
                                        <small class="text-info">Maximal ukuran 5MB.</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <x-input_file type="text" name="background_image_3" label="Gambar Latar belakang 3" :value="$invitation->quote->background_image_3 ?? ''" />
                                        <small class="text-info">Maximal ukuran 5MB.</small>
                                    </div>
                                </div>
                                <div class="col-md-12">
                ...
                @endif
                <form action="{{ isset($invitation->event) ? route('invitations.sideright_template.action_event', $invitation->event->uuid) : route('invitations.sideright_template.action_event') }}" method="POST">
                    @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.sideright_template.action_love_story') }}" method="POST">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                        ...
                                        @foreach ($invitation->love_stories as $item)
                                            <tr>
                                                ...
                                                <td class="text-nowrap width-1">
                                                    <form action="{{ route('invitations.sideright_template.action_love_story', $item->uuid) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                        <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                @endif
                <form action="{{ isset($invitation->streaming) ? route('invitations.sideright_template.action_streaming', $invitation->streaming->uuid) : route('invitations.sideright_template.action_streaming') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.sideright_template.action_gift') }}" method="POST">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                        ...
                                        @foreach ($invitation->gifts as $item)
                                            @if ($item->gift_type_name === 'Rekening Bank')
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap width-1">
                                                        <form action="{{ route('invitations.sideright_template.action_gift', $item->uuid) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.sideright_template.action_gallery') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <x-input_file type="file" name="photo" label="Foto" />
                                    ...
                                    @foreach ($invitation->galleries as $item)
                                        <div class="col-4 col-sm-3 col-md-2 col-lg-2 position-relative mb-3">
                                            <a href="{{ Storage::url($item->photo) }}" target="_blank" data-fancybox="gallery-2">
                                                <img src="{{ Storage::url($item->photo) }}" class="img-thumbnail" style="object-fit: ; width: 100%; height: 100px" />
                                            </a>
                                            <form action="{{ route('invitations.sideright_template.action_gallery', $item->uuid) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                @endif
                <form action="{{ isset($invitation->audio) ? route('invitations.sideright_template.action_audio', $invitation->audio->uuid) : route('invitations.sideright_template.action_audio') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <x-input_file type="text" name="audio_file" label="File Musik" :value="$invitation->audio->audio_file ?? ''" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @endif
                <form action="{{ isset($invitation->closing) ? route('invitations.sideright_template.action_closing', $invitation->closing->uuid) : route('invitations.sideright_template.action_closing') }}" method="POST">
                    @csrf
                ...
                <div class="card">
                    <div class="card-header">
                        <h6>Pastikan data undangan sudah dilengkapi!</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('invitations.sideright_template.action_guest') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-serverside-guests").DataTable({
                ...
                order: [],
                ajax: {
                    url: "/invitations/sideright_template/edit/" + invitation_uuid,
                    data: {
                        type: 'guests'
                    }
                },
                columns: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            <form action="/invitations/sideright_template/action_guest/${row.uuid}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
            ...
            $("#table-serverside-messages").DataTable({
                ...
                columns: [{
                    ...
                    "render": function(data, type, row) {
                        return ` 
                            <form action="/invitations/sideright_template/action_message/${row.uuid}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="invitation_id" id="invitation_id" value="${invitation_id}">
                                <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="${invitation_uuid}">
