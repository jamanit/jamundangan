@extends('invitation.calm_template.V_calm_layout')
...
@section('content')
    ...
    <div class="fixed z-0 h-screen w-full lg:w-1/3">
        <img src="{{ asset('/') }}invitation_templates/storage/cover/red-cover-image.jpg" class="inset-0 z-0 h-full w-full object-cover" alt="Cover Image" />
        <div class="absolute inset-0 z-10 h-full w-full bg-black opacity-50"></div>
    </div>
    ...
    <footer id="bottom-footer" class="fixed bottom-0 z-40 flex hidden w-full flex-col items-center px-2">
        ...
        <div class="mb-2 flex w-full justify-end overflow-hidden lg:w-1/3">
            <button id="toggle-audio" onclick="toggleAudio()" class="rounded-full bg-red-500 px-4 py-2 text-sm text-white hover:bg-red-600" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <i class="fas fa-pause"></i>
            </button>
            <audio id="background-audio" loop="">
                @if ($invitation->audio)
                    <source src="{{ url('/invitations/calm_template/play_audio/' . $invitation->audio->audio_file) }}" type="audio/mpeg">
        ...
        <div id="menu" class="flex w-full overflow-x-auto rounded-lg bg-gray-800 py-2 text-white lg:w-1/3" data-aos="fade-up" data-aos-offset="50" data-aos-duration="500">
            <div class="flex space-x-4 px-4">
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg bg-gray-700 text-red-400 transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'cover-section', 'text-red-400')">
                    <i class="fas fa-envelope text-base"></i>
                    <span class="text-base">Cover</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'quote-section', 'text-red-400')">
                    <i class="fas fa-quote-left text-base"></i>
                    <span class="text-base">Kutipan</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'wedding-couple-section', 'text-red-400')">
                    <i class="fas fa-heart text-base"></i>
                    <span class="text-base">Mempelai</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'event-section', 'text-red-400')">
                    <i class="fas fa-calendar-alt text-base"></i>
                    <span class="text-base">Acara</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'message-section', 'text-red-400')">
                    <i class="fas fa-message text-base"></i>
                    <span class="text-base">Ucapan</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'love-story-section', 'text-red-400')">
                    <i class="fas fa-sticky-note text-base"></i>
                    <span class="text-base">Cerita</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'gallery-section', 'text-red-400')">
                    <i class="fas fa-image text-base"></i>
                    <span class="text-base">Galeri</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'streaming-section', 'text-red-400')">
                    <i class="fas fa-video text-base"></i>
                    <span class="text-base">Streaming</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'gift-section', 'text-red-400')">
                    <i class="fas fa-gift text-base"></i>
                    <span class="text-base">Hadiah</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'closing-section', 'text-red-400')">
                    <i class="fas fa-door-closed text-base"></i>
                    <span class="text-base">Penutup</span>
                </div>
                <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-red-400" onclick="setActive(this, 'jaman-section', 'text-red-400')">
                    <i class="fas fa-copyright text-base"></i>
                    <span class="text-base">Jaman IT</span>
                </div>
            </div>
        </div>
    </footer>
    ...
    <div class="relative z-20 h-full w-full lg:w-1/3">
        ...
        <section id="cover-section" class="relative h-auto w-full overflow-hidden">
            <div class="relative w-full">
                <img src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/image/red-flower-1.png" class="absolute left-0 top-0 z-20 w-2/6" data-aos="fade-right" />
                <img src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/image/red-flower-2.png" class="absolute right-0 top-0 z-20 w-2/6" data-aos="fade-left" />
            </div>
            ...
            <div class="relative z-30 mx-4 my-4 flex h-screen flex-col items-center justify-center">
                ...
                <div id="countdown" data-countdown="{{ $nearest_date }}" class="flex justify-center gap-2 mb-4" data-aos="zoom-in">
                    <div class="bg-white/50 border-2 border-red-500 rounded-lg p-2 shadow-lg w-15 text-center">
                        <span id="days" class="text-xl font-bold text-red-500">00</span>
                        <div class="text-sm text-white">Hari</div>
                    </div>
                    <div class="bg-white/50 border-2 border-red-500 rounded-lg p-2 shadow-lg w-15 text-center">
                        <span id="hours" class="text-xl font-bold text-red-500">00</span>
                        <div class="text-sm text-white">Jam</div>
                    </div>
                    <div class="bg-white/50 border-2 border-red-500 rounded-lg p-2 shadow-lg w-15 text-center">
                        <span id="minutes" class="text-xl font-bold text-red-500">00</span>
                        <div class="text-sm text-white">Menit</div>
                    </div>
                    <div class="bg-white/50 border-2 border-red-500 rounded-lg p-2 shadow-lg w-15 text-center">
                        <span id="seconds" class="text-xl font-bold text-red-500">00</span>
                ...
                <div class="text-center" data-aos="fade-up">
                    ...
                    <button onclick="openInvitation('text-red-400')" class="mx-auto mt-6 rounded-full bg-red-500 px-4 py-2 text-base text-white hover:bg-red-600">
            ...
            <div class="relative z-30 mx-4 my-4 mb-28 flex h-full flex-col items-center">
                @if ($invitation->wedding_couple)
                    <div class="flex flex-col items-center" data-aos="fade-down">
                        <img src="{{ Storage::url($invitation->wedding_couple->bride_photo) }}" class="mb-2 h-24 w-24 rounded-full border-4 border-red-400 object-cover" />
                        <p class="font-sacramento text-4xl font-semibold text-red-400">{{ $invitation->wedding_couple->bride_nickname }}</p>
                    ...
                    <div class="flex flex-col items-center" data-aos="fade-up">
                        <p class="my-6 font-sacramento text-4xl font-semibold text-red-400">&</p>

                        <img src="{{ Storage::url($invitation->wedding_couple->groom_photo) }}" class="mb-2 h-24 w-24 rounded-full border-4 border-red-400 object-cover" />
                        <p class="font-sacramento text-4xl font-semibold text-red-400">{{ $invitation->wedding_couple->groom_nickname }}</p>
        ...
        <section id="event-section" class="relative hidden h-auto w-full overflow-hidden">
            ...
            <div class="relative z-30 mx-4 my-4 mb-28 mt-10 flex h-full flex-col items-center">
                @if ($invitation->event && !empty(trim($invitation->event->event_date_1)))
                    <div class="mb-4 w-full rounded-lg border-2 border-red-400 bg-white/75 p-6 text-center text-gray-600 shadow-lg" data-aos="zoom-in">
                        <p class="mb-2 font-sacramento text-4xl font-semibold text-red-400">{{ $invitation->event->event_type_1 }}</p>
                        ...
                        <a href="{{ $invitation->event->map_url_1 }}" target="_blank">
                            <button class="mx-auto mt-1 rounded-full bg-red-500 px-4 py-2 text-sm text-white hover:bg-red-600">
                ...
                @if ($invitation->event && !empty(trim($invitation->event->event_date_2)))
                    <div class="mb-4 w-full rounded-lg border-2 border-red-400 bg-white/75 p-6 text-center text-gray-600 shadow-lg" data-aos="zoom-in">
                        <p class="mb-2 font-sacramento text-4xl font-semibold text-red-400">{{ $invitation->event->event_type_2 }}</p>
                ...
                @if ($invitation->event && !empty(trim($invitation->event->event_date_3)))
                    <div class="mb-4 w-full rounded-lg border-2 border-red-400 bg-white/75 p-6 text-center text-gray-600 shadow-lg" data-aos="zoom-in">
                        <p class="mb-2 font-sacramento text-4xl font-semibold text-red-400">{{ $invitation->event->event_type_3 }}</p>
        ...
        <section id="message-section" class="relative hidden h-auto w-full overflow-hidden">
            ...
            <div class="relative z-30 mx-4 my-4 mb-28 mt-10 flex h-full flex-col items-center">
                <div class="mb-4 w-full rounded-lg border-2 border-red-400 bg-white/75 p-6 shadow-lg" data-aos="flip-left">
                    <form id="message-form" onsubmit="sendMessage(event, 'bg-red-500')">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" placeholder="Masukkan nama Anda" class="w-full rounded-lg border border-red-400 p-3 focus:outline-none focus:ring-2 focus:ring-red-400" />
                        </div>
                        <div class="mb-4">
                            <label for="message" class="mb-2 block text-left text-sm font-semibold text-gray-600">Pesan</label>
                            <textarea name="message" id="message" placeholder="Berikan ucapan serta doa restu Anda" class="w-full rounded-lg border border-red-400 p-3 focus:outline-none focus:ring-2 focus:ring-red-400" rows="2"></textarea>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4" id="guest_input" style="display: none">
                            ...
                            <input type="number" name="guest_totals" id="guest_totals" placeholder="Masukkan jumlah tamu (orang)" class="w-full rounded-lg border border-red-400 p-3 focus:outline-none focus:ring-2 focus:ring-red-400" />
                        </div>
                        <button type="submit" class="mt-4 w-full rounded-full bg-red-500 p-2 text-base text-white hover:bg-red-600">
                            <i class="fas fa-message"></i> KIRIM UCAPAN
                        </button>
                    </form>

                    <div id="messages" class="mt-8 hidden max-h-80 space-y-4 overflow-y-auto rounded-lg border border-gray-300 p-2">
            ...
            <div class="relative z-30 mx-4 my-4 mb-28 mt-10 flex h-full flex-col items-center">
                @if (!$invitation->love_stories->isEmpty())
                    @foreach ($invitation->love_stories as $item)
                        <div class="mb-4 w-full rounded-lg border-2 border-red-400 bg-white/75 p-6 text-center text-gray-600 shadow-lg" data-aos="fade-up">
                            <p class="mb-4 text-center font-sacramento text-2xl font-semibold text-red-400">
                                {{ $item->title }}
                            </p>
        ...
        <section id="streaming-section" class="relative hidden h-auto w-full overflow-hidden">
            ...
            <div class="relative z-30 mx-4 my-4 mb-28 flex h-screen flex-col items-center justify-center">
                @if ($invitation->streaming)
                    <iframe class="rounded-lg" width="100%" height="315" src="https://www.youtube.com/embed/{{ $invitation->streaming->youtube_url_id }}" title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-aos="zoom-in">
                    </iframe>
                @endif
            </div>
        </section>
        ...
        <section id="gift-section" class="relative hidden h-auto w-full overflow-hidden">
            ...
            <div class="relative z-30 mx-4 my-4 mb-28 mt-10 flex h-screen flex-col items-center justify-center">
                @if (!$invitation->gifts->isEmpty())
                    <div class="mb-4 w-full rounded-lg border-2 border-red-400 bg-white/75 p-6 shadow-lg" data-aos="fade-up">
                        ...
                        <button id="open-modal" class="w-full rounded-full bg-red-500 p-2 text-base text-white hover:bg-red-600">
        ...
        @if (!$invitation->gifts->isEmpty())
            <div id="gift-modal" class="fixed inset-0 z-50 flex hidden justify-center bg-black bg-opacity-50 py-4">
                <div class="relative mx-4 max-h-[80vh] w-full max-w-md overflow-hidden rounded-lg bg-white">
                    <div class="flex p-4">
                        <p class="font-sacramento text-4xl font-semibold text-red-400">Hadiah</p>
                    ...
                    <div class="max-h-[70vh] overflow-y-auto px-4 pb-8 pt-4">
                        ...
                        @foreach ($bankAccounts as $item)
                            <div class="relative mb-4">
                                <img src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/image/card-money.jpg" class="h-40 w-full rounded-3xl border-2 border-red-400 object-cover" />
                                <div class="absolute inset-0 flex flex-col items-start justify-center pl-4">
                                    <p class="px-4 py-1 text-2xl font-semibold text-red-400">{{ $item->account_name }}</p>
                                    <p class="px-4 py-1 text-2xl">
                                        {{ $item->account_number }}
                                        <i id="copy-icon" class="fa-regular fa-copy cursor-pointer hover:text-red-400" onclick="copyToClipboard('bg-red-500', '{{ $item->account_number }}')"></i>
                                    </p>
                        ...
                        @foreach ($other_gifts as $item)
                            <div class="relative mb-4">
                                <div class="flex rounded-3xl border-2 border-red-400 p-2">
                                    <div class="flex items-center px-4">
                                        <i class="fas fa-gift text-3xl text-red-400"></i>
                                    </div>
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <p class="px-1 py-1 text-base">
                                            ...
                                            <i class="fa-regular fa-copy cursor-pointer text-2xl hover:text-red-400" onclick="copyToClipboard('bg-red-500', '{{ $item->recipient_name . ' / ' . $item->recipient_phone_number . ' / ' . $item->recipient_address }}')">
                                            </i>
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="relative z-30 mx-4 my-4 mb-28 flex h-screen flex-col items-center justify-center text-center">
                @if ($invitation->closing)
                    ...
                    <div data-aos="fade-up">
                        ...
                        <p class="pb-32 font-sacramento text-4xl font-semibold text-red-400">{{ $invitation->wedding_couple ? $invitation->wedding_couple->bride_nickname . ' & ' . $invitation->wedding_couple->groom_nickname : 'Wanite & Pria' }}</p>
                    </div>
                @endif
            </div>
        </section>
        ...
        <!-- jaman it section -->
        <section id="jaman-section" class="relative hidden h-auto w-full overflow-hidden">
            <div class="relative w-full">
                <img src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/image/red-flower-1.png" class="absolute left-0 top-0 z-20 w-2/6" data-aos="fade-right" />
                <img src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/image/red-flower-2.png" class="absolute right-0 top-0 z-20 w-2/6" data-aos="fade-left" />
            </div>
                ...
                @if (!$contacts->isEmpty())
                    <div class="mb-4 flex space-x-4 text-white" data-aos="zoom-in">
                        @foreach ($contacts as $item)
                            <a href="{{ $item->url }}" class="hover:text-red-400" title="{{ $item->platform }}" target="_blank">
