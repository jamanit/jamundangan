    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                @endif
                <form action="{{ isset($invitation->wedding_couple) ? route('invitations.calm_template.action_wedding_couple', $invitation->wedding_couple->uuid) : route('invitations.calm_template.action_wedding_couple') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                @endif
                <form action="{{ isset($invitation->quote) ? route('invitations.calm_template.action_quote', $invitation->quote->uuid) : route('invitations.calm_template.action_quote') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                @endif
                <form action="{{ isset($invitation->event) ? route('invitations.calm_template.action_event', $invitation->event->uuid) : route('invitations.calm_template.action_event') }}" method="POST">
                    @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.calm_template.action_love_story') }}" method="POST">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                        ...
                                        @foreach ($invitation->love_stories as $item)
                                            <tr>
                                                ...
                                                <td class="text-nowrap width-1">
                                                    <form action="{{ route('invitations.calm_template.action_love_story', $item->uuid) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                        <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                @endif
                <form action="{{ isset($invitation->streaming) ? route('invitations.calm_template.action_streaming', $invitation->streaming->uuid) : route('invitations.calm_template.action_streaming') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.calm_template.action_gift') }}" method="POST">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                        ...
                                        @foreach ($invitation->gifts as $item)
                                            @if ($item->gift_type_name === 'Rekening Bank')
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap width-1">
                                                        <form action="{{ route('invitations.calm_template.action_gift', $item->uuid) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.calm_template.action_gallery') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                ...
                                <div class="row">
                                    @foreach ($invitation->galleries as $item)
                                        <div class="col-4 col-sm-3 col-md-2 col-lg-2 position-relative mb-3">
                                            ...
                                            <form action="{{ route('invitations.calm_template.action_gallery', $item->uuid) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                @endif
                <form action="{{ isset($invitation->audio) ? route('invitations.calm_template.action_audio', $invitation->audio->uuid) : route('invitations.calm_template.action_audio') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                @endif
                <form action="{{ isset($invitation->closing) ? route('invitations.calm_template.action_closing', $invitation->closing->uuid) : route('invitations.calm_template.action_closing') }}" method="POST">
                    @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('invitations.calm_template.action_guest') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-serverside-guests").DataTable({
                ...
                order: [],
                ajax: {
                    url: "/invitations/calm_template/edit/" + invitation_uuid,
                    data: {
                        type: 'guests'
                    }
                },
                columns: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            <form action="/invitations/calm_template/action_guest/${row.uuid}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
            ...
            $("#table-serverside-messages").DataTable({
                ...
                columns: [{
                    ...
                    "render": function(data, type, row) {
                        return ` 
                            <form action="/invitations/calm_template/action_message/${row.uuid}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="invitation_id" id="invitation_id" value="${invitation_id}">
                                <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="${invitation_uuid}">
