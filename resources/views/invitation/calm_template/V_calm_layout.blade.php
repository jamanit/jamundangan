...
<head>
    ...
    <link href="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/fortawesome/fontawesome-free/css/all.css" rel="stylesheet" />
    <link href="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/aos/dist/aos.css" rel="stylesheet" />
    <link href="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/fancyapps/ui/dist/fancybox/fancybox.css" rel="stylesheet" />
    <script src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/sweetalert2/dist/sweetalert2.all.min.js"></script>
    <script src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/moment/moment.js"></script>
    <script src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/moment-countdown/dist/moment-countdown.min.js"></script>
    <link href="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/tailwind-output.css" rel="stylesheet" />
...
<body class="flex h-screen w-full items-center justify-center bg-primary-red-400 font-worksans">
    ...
    <script src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/aos/dist/aos.js"></script>
    <script src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/fancyapps/ui/dist/fancybox/fancybox.umd.js"></script>
    <script src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/jquery/dist/jquery.min.js"></script>
    <script src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/costume-script.js"></script>
    ...
    <script>
        ...
        function sendMessage(event, color) {
            ...
            $.ajax({
                url: '/invitations/calm_template/send_message', // Ganti dengan endpoint yang sesuai
                method: 'POST',
        ...
        function fetchLatestMessages() {
            const invitation_id = $("#invitation_id").val();
            $.ajax({
                url: '/invitations/calm_template/get_message/' + invitation_id,
                method: 'GET',
                success: function(data) {
