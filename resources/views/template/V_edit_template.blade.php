                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <x-input_file type="file" name="image" label="Image" :value="$template->image" />
                                            </div>
                                            <div class="mb-3">
                                                <x-select name="invitation_type_id" label="Invitation Type" :options="$invitation_type_list" :selected="$template->invitation_type_id" />
                                            </div>
                                            <div class="mb-3">
