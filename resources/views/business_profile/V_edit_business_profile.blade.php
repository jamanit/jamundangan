            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="{{ route('business_profiles.update', $business_profile->uuid) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <x-input_file type="file" name="logo" :value="$business_profile->logo" label="Logo" placeholder="Enter Logo" />
                                            </div>
                                            <div class="mb-3">
